...
The current live deck places each literature discussion after its study results and keeps cohort/detail slides in backup. The **Recorded edition** uses its preserved slide sequence and complete original narration. These are separate deck files so the older audio cannot steer the revised live presentation into the wrong slides.
